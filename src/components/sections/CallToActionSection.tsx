  ...
  return <section className="px-4 py-20 md:px-6 lg:px-8 bg-gradient-to-r from-[#FF4438] to-[#FDBD50]">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button className="bg-white text-[#FF4438] hover:bg-white/10 hover:text-white hover:border-white border border-transparent px-4 sm:px-8 py-4 text-sm sm:text-lg rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 font-semibold">
